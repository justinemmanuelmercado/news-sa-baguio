...
exports.PuppeteerHandler = void 0;
var puppeteer_1 = __importDefault(require("puppeteer"));
var PuppeteerHandler = /** @class */ (function () {
    function PuppeteerHandler() {
        ...
        this.openPage = function (url) { return __awaiter(_this, void 0, void 0, function () {
            var page;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        _b.label = 2;
                    case 2: return [4 /*yield*/, ((_a = this.browser) === null || _a === void 0 ? void 0 : _a.newPage())];
                    case 3:
                        page = _b.sent();
                        if (page) {
                            if (url) {
                                console.log("Opening new page " + url);
                                page === null || page === void 0 ? void 0 : page.goto(url);
                            }
                            else {
