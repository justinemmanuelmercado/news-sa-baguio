    ...
    return (
        <div>
            <button
                ...
                className={`focus:outline-black bg-gray-100 odd:bg-gray-50 flex flex-row rounded-sm cursor-pointer text-left max-h-40 min-h-32 hover:text-green-100 border border-gray-300 w-full ${
