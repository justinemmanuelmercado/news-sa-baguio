...
const LoadingArticle = () => {
    return (
        <div className="animate-pulse bg-gray-700 flex flex-row rounded-sm shadow-lg text-left h-40 min-h-32 hover:text-green-100 border border-gray-900 w-full">
...
function ArticlesList({
    ...
    const { setCompactContent, compactContent } = useContext(CompactContentContext)
